const calculateCGPA = (details) => {
  ...
  return ((
    ...
    (Number(details.cgpa1) +
      Number(details.cgpa2) +
      Number(details.cgpa3) +
      Number(details.cgpa4) +
      Number(details.cgpa5) +
      Number(details.cgpa6) +
      Number(details.cgpa7) +
      Number(details.cgpa8)
    ));
};
